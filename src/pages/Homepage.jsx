    ...
    return (
        <>
            ...
            <div className="taglist-container">
                {showTags && <TagList isAdmin={isAdmin} clicked={handleTagClick} />}
                {showTags ? (
                    <div className="trangle-container">
                        <AiOutlineCaretUp className="triangle" onClick={handleShowTags} />
                        <p className="show-tags">Hide tags</p>
                    </div>
                ) : (
                    <div className="triangle-container">
                        <AiOutlineCaretDown className="triangle" onClick={handleShowTags} />
